            ...
            <PageContext.Consumer> 
                { 
                    (settings) => {
                        ...
                        return (<div className="flex flex-1 text-black p-10 pb-2 pt-2 md:p-10 md:pb-6 md:pt-6 flex-col bg-sky-600">
                            <div className="flex flex-row-reverse ">
                                <div className="flex flex-row justify-center items-center bg-white pr-6 pl-3 pt-2 pb-2 rounded-xl">
